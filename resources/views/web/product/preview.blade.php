            ...
            <div class="container mx-auto my-4 shadow-md ">
                ...
                <div>
                    ...
                    <div class="flex justify-center">
                        <a class="text-center font-semibold mx-auto py-2 px-4 my-4 bg-gray-900 text-white transition-all duration-300 hover:bg-gray-400 hover:text-gray-900" href="{{ route('order.preview', $product) }}">Comprar</a>
                    </div>
                </div>
            </div>
    </div>
